...
export const KNOWN_PUBLIC_DOMAIN_CODES = new Set<string>([
  ...
  'GEOFENCE_EXCEEDED',
  'GUEST_NAME_TOO_LONG',
  'INVALID_REWARDS_PHONE',
  'INVALID_REWARDS_TEXT',
  'REWARDS_CUSTOMER_NOT_FOUND',
  'REWARDS_CONCURRENCY_RETRY',
  'PAYMENT_TRANSACTION_NOT_FOUND',
  'INVALID_PAYMENT_STATUS',
  'NO_REWARD_POINTS_FOR_AMOUNT',
  'INVALID_SETTLEMENT_STATUS',
  'REWARDS_LEDGER_NOT_FOUND',
  'REWARDS_REVERSAL_INVALID',
  'REWARDS_ALREADY_REVERSED',
  'INVALID_REWARD_ITEM',
  'INVALID_REWARD_POINTS_COST',
  ...
  'REVIEWS_DISABLED',
  'ROTATION_CONFLICT',
  'REWARDS_CONSENT_REQUIRED',
  'SERVICE_ACTION_NOT_SUPPORTED',
  'SETTLE_CONFLICT',
  'SETTLE_CLOSURE_INCOMPLETE',
  'SKIP_PREORDER_REQUIRES_REASON',
  'SMART_TIPS_DISABLED',
...
const UNSAFE_MESSAGE_PATTERNS = [
  /\b[A-Za-z_][A-Za-z0-9_-]*\s*=(?!=)\s*\S+/, // Asignaciones clave=valor; permite comparadores como >= 2
  /\\/,                    // Rutas o escapes de infraestructura
