...
import { ChefAIGenerateResponse, MenuTemplateId, AiDiagnosticsDTO } from '@mesaya/shared';
import { AdminApi } from '../lib/api';
import { Sparkles, Bot, Check, ArrowRight, Loader2, Utensils, Flame, Waves, Coffee, X, AlertTriangle, Activity } from 'lucide-react';
